...
from app import tingting_brand as brand
...
try:
    ...
    DESCRIPTION = (
        "An agent that creates the Ting Ting episode concept: learning "
        "objective, tiny story, original song lyrics and scene beat plan."
    )
    story_agent = Agent(
        model=MODEL,
        name="story_agent",
